# Issue iss-1784925504899-sqtkv1

**Summary:** log out confirm
**Category:** bug
**Reported:** 2026-07-24T20:38:24.899Z
**Engine:** default
...
### Details
  ...
  description: The sign out button should use the same themed confirm as the delete bucket button.
```
...
The background agent identified additional raw `confirm()` usages in the codebase, but those are outside the scope of this issue. The reported issue was specifically about the sign out button matching the delete bucket button's themed confirm, and that fix is complete.
