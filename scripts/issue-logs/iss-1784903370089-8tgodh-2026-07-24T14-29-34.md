# Issue iss-1784903370089-8tgodh

**Summary:** close button
**Category:** bug
**Reported:** 2026-07-24T14:29:30.089Z
**Exit code:** 0
...
### Details
  ...
  description: the saves sessions sidebar close button should be an icon.
```
...
The background agent confirmed the same finding I already fixed. The close button in the saved sessions sidebar at `App.tsx:549-551` used text `"Close"` instead of the `AppIcon` close icon component. The fix has been applied — no further changes needed.
