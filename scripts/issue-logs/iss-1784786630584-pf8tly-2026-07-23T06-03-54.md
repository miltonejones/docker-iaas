...
The background agent confirms the same finding — the system prompt is the `SYSTEM` constant in `/app/server/src/routes/assistant.ts:98`, and my edit is already applied. No further action needed.
