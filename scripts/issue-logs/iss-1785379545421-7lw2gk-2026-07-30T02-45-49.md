# Issue iss-1785379545421-7lw2gk

**Summary:** .project-detail__main
**Category:** bug
**Reported:** 2026-07-30T02:45:45.421Z
**Engine:** default
...
### Details
  ...
  description: the padding on .project-detail__main should be 0 12px
```
...
Both background agents confirmed the same findings — the fix is already applied. No further changes needed.
