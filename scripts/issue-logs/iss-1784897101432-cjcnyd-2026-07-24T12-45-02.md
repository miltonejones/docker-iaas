# Issue iss-1784897101432-cjcnyd

**Summary:** Status filter
**Category:** missing_feature
**Reported:** 2026-07-24T12:45:01.432Z
**Exit code:** 0
...
### Details
  ...
  description: The status filter on the issues list should be a dropdown
```
...
The background agent's findings confirm my analysis — the only status filter UI in the codebase was the tab bar in `IssuesList.tsx`, which I've already converted to a dropdown. No further changes needed.
