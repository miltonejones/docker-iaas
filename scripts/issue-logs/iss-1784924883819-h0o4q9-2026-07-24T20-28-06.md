# Issue iss-1784924883819-h0o4q9

**Summary:** search inputs
**Category:** missing_feature
**Reported:** 2026-07-24T20:28:03.819Z
...
### Details
  ...
  description: all search and filter inputs should have the curved styling of the .assistant-search input.
```
...
Both background agents have confirmed the same three search/filter inputs I identified. The fix is already applied — the `.search-input` class now has the complete pill-shaped styling matching `.assistant-search`, covering the offcanvas sessions search, the instances filter, and the issues status filter dropdown. No additional changes are needed.
