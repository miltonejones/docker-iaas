...
export const PRESETS: Preset[] = [
  ...
  },
  {
    ...
    description: 'Rock-solid stable. Ubuntu\'s parent — lighter footprint.',
    icon: '🌀',
    ports: [
  ...
  },
  {
    ...
    category: 'OS',
    image: 'alpine:latest',
    description: 'Ultra-minimal musl/BusyBox image. The standard for tiny containers.',
    icon: '🏔️',
    ports: [
  ...
  },
  {
    ...
    category: 'OS',
    image: 'fedora:latest',
    description: 'Red Hat\'s community distro with cutting-edge packages.',
    icon: '🎩',
    ports: [
  ...
  },
  {
    ...
    category: 'OS',
    image: 'rockylinux:9',
    description: 'RHEL-compatible, CentOS successor — enterprise-ready.',
    icon: '🪨',
    ports: [
  ...
  },
  {
    ...
    category: 'OS',
    image: 'archlinux:latest',
    description: 'Rolling release, bleeding-edge. For devs who want the latest everything.',
    icon: '🎯',
    ports: [
